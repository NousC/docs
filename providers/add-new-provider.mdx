...
All providers are connected through **Settings → Integrations** in the Nous app. You do not need to edit config files for integrations — they are stored per workspace in the database and encrypted at rest.
