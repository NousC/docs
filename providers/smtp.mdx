...
| **IMAP host**_(optional)_ | Override IMAP hostname if different from SMTP. Nous auto-derives it by replacing `smtp.` → `imap.` if not set. |
| **IMAP port**_(optional)_ | Defaults to `993` |
