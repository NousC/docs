---
title: "Contributing"
description: "How to get started developing and contributing to Nous"
---
...
Nous is open-source and the code is at [github.com/bennetglinder1/nous](https://github.com/bennetglinder1/nous).
...
- **Over 3 lines** — open an issue or discuss in [Discord](https://discord.gg/2Ph4ZYXw) first. This avoids wasted effort if the approach doesn't fit the direction.
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/2Ph4ZYXw">
    Fastest way to get help — chat, screenshots, screen sharing.
  </Card>
  <Card title="GitHub Issues" icon="github" href="https://github.com/bennetglinder1/nous/issues/new/choose">
