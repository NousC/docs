...
Nous is open-source and the code is at [github.com/NousC/opennous](https://github.com/NousC/opennous).
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/NousC/opennous/issues/new/choose">
