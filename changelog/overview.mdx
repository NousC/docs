...
The Claude Code plugin gains a **`/nous-login`** command. It opens your browser, you approve, and a workspace API key is minted and saved automatically. Pasting a key still works as a fallback. New sign-ups now go straight from signup to install and let the agent handle onboarding.
