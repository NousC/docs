...
<Warning>
  Required on first setup. Open your Supabase project → **SQL Editor** → paste and run [`supabase/schema.sql`](https://github.com/NousC/nous/blob/main/supabase/schema.sql).
</Warning>
