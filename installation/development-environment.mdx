...
description: "Run Nous locally for development"
---
...
<Warning>
  Required on first setup. Open your Supabase project → **SQL Editor** → paste and run [`supabase/schema.sql`](https://github.com/bennetglinder1/nous/blob/main/supabase/schema.sql).
</Warning>
