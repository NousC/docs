...
<Note>
Self-hosters don't have **Lead Lists** or **CRM Sync** — those are Nous Cloud only. Everything else (the context graph, the MCP server + all agent tools, ICP scoring, enrichment, integrations) is fully open.
</Note>
