...
flowchart LR
    ...
    api["Context API (/v2/*)"]:::output
    mcp["MCP Server"]:::output
    sdk["SDKs (TS, Python)"]:::output
...
The output surfaces — Context API, MCP, SDKs — are thin wrappers around the substrate. The substrate is the product.
