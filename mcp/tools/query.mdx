...
For workspace-level facts about your own business (ICP, pricing, etc.) use [`get_workspace_facts`](/mcp/tools/get-workspace-facts) — `query` is for per-entity observations only.
