...
For raw data ("what do we know about X?"), prefer [`get_account`](/mcp/tools/get-account). For questions about your OWN business (ICP, pricing), use [`get_workspace_facts`](/mcp/tools/get-workspace-facts).
