...
The Nous MCP server is a thin stdio process that exposes the v2 Context API as **seven tools** any MCP-compatible client can call. Your agent gets engineered, epistemics-tagged context — never raw rows.
