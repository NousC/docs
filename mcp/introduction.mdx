---
title: "MCP Server"
description: "@opennous/mcp — give Claude Code, Codex, Cursor, and any MCP-compatible client one call into the Nous customer graph."
---
...
### Read and write the customer graph
