...
The Nous MCP server exposes the v2 customer graph as **ten tools** any MCP-compatible client can call. Your agent gets engineered, epistemics-tagged context, never raw rows.
